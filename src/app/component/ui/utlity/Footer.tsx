...
const Footer: React.FC<FooterProps> = ({
  ...
  socialLinks = [
    { platform: "facebook", href: "https://www.facebook.com/profile.php?id=61556225696578&mibextid=rS40aB7S9Ucbxw6v" },
    { platform: "instagram", href: "https://www.instagram.com/woman.ej?igsh=MWsxZjhteHJ5Y3Qxcw==" },
  ],
