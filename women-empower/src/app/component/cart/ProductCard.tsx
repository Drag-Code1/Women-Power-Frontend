...
import {  AddToCartIconButton } from '../ui/buttons/AddToCartICon';
import { VisibilityIconButton } from '../ui/buttons/VisibilityIconButton';
import { WishListIconButton } from '../ui/buttons/WishListIconButton';
import ids from '../../styles/productCard.module.css'
interface Product {
  id: number;
  title: string;
  category: string;
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-64 sm:h-72 bg-gray-100 overflow-hidden">
        ...
        <div  className={`${ids['side-icons']} absolute top-3 right-3 flex flex-col gap-2 
      `
...
{/*           
          ...
          <VisibilityIconButton product={product}/>
          {/* <button
