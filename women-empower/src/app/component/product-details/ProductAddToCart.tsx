"use client"
import { fetchAddToCart } from "@/app/lib/api";
import { useAppDispatch, useAppSelector } from "@/state-management/hooks";
import { addItem, CartItem } from "@/state-management/slices/cartSlice";
...
export const ProductAddToCart:React.FC<AddToCartProps> =({id})=>{
...
//dispatch(addItem({id:1,name:"Sample Item",price:100,offerPrice:120,quantity:1,image:"/sample.jpg"}));
    ...
    return(
        ...
        <button disabled={selector.find(item=>item.productId===id) } onClick={addToCart} className="w-full bg-[#695946] text-white py-3 px-6 rounded-lg font-medium hover:bg-[#5a4a3a] transition-colors shadow-sm">
