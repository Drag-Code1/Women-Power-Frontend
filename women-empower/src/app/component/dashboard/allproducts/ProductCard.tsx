...
import { Star, TrendingUp, MoreVertical, Edit, Eye, Trash2 } from 'lucide-react';
import { Product } from '@/app/types/types';
import { calculateDiscountedPrice } from '@/app/component/dashboard/allproducts/utils';

// Define a fallback image if DEFAULT_PRODUCT_IMAGE is not exported from utils
  ...
  return (
    ...
    >
      <div className="relative">
        <img
          src={product.p_images[0] || DEFAULT_PRODUCT_IMAGE}
          alt={product.p_Name}
        ...
        <div className="absolute top-2 right-2 z-30">
          <button
            onClick={(e) => {
              e.stopPropagation();
              setShowDropdown(showDropdown === product.id ? null : product.id);
            }}
      ...
      <div className="p-3 flex-1 flex flex-col justify-between">
        <div>
          ...
          <div className="flex items-center mb-2">
            ...
            <span className="ml-2 text-xs text-gray-500">({product.review_id})</span>
          </div>
        </div>
