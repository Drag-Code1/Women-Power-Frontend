...
import { TrendingUp, MoreVertical, Eye, Edit, Trash2 } from "lucide-react";
import { Product } from "@/app/types/dashboard-product";
import { calculateDiscountedPrice } from "@/app/lib/utils/dashboardproduct-utils";
import { DEFAULT_PRODUCT_IMAGE } from "@/app/data/dashboard-productdata";
...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div
      className="bg-white rounded-md shadow-sm hover:shadow-md transition-all duration-200 group h-[280px] flex flex-col"
