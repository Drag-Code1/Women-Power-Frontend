...
interface FaqItemProp {
  ...
  export const FaqItem: React.FC<FaqItemProp> = ({ faq, searchParams }) => {

  const faqId = searchParams ? searchParams['faqid'] : undefined;
...
<FaqExpand faq={faq}/>
              <div
                ...
                className={`overflow-hidden transition-all duration-300 ${
                 faqId && Number(faqId) === faq.id ? "max-h-96 opacity-100" : "max-h-0 opacity-0"
                }`}
              >
